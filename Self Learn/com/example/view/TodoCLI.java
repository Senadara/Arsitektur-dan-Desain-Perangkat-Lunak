...
public class TodoCLI {
    ...
    public TodoCLI(TodoService todoService, Exportable exporter) {
        ...
        while (running) {
            ...
            try {
                switch (choice) {
                    ...
                    case 3: markTodoAsCompleted(); break;
                    case 4: updateTodo(); break;
                    case 5: deleteTodo(); break;
                    case 6: exportTodos(); break;
                    case 7: running = false; System.out.println("Terima kasih telah menggunakan TodoList CLI!"); break;
    ...
    private void displayMenu() {
        ...
        System.out.println("6. Export Todos");
